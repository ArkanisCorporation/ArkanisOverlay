...
public static class MudBlazorIconMapping
{
    ...
    private static string GetMaterialIconString(string iconName)
        => iconName switch
        {
            ...
            OverlayIcons.Navigation.ChevronLeft => MudBlazor.Icons.Material.Filled.ChevronLeft,
            OverlayIcons.Navigation.OpenInBrowser => MudBlazor.Icons.Material.Filled.OpenInBrowser,
            ...
            OverlayIcons.Actions.FrameReload => MudBlazor.Icons.Material.Filled.Refresh,

            // System icons
            OverlayIcons.System.Settings => MudBlazor.Icons.Material.Filled.Settings,
            OverlayIcons.System.ScreenshotMonitor => MudBlazor.Icons.Material.Filled.Monitor,
            OverlayIcons.System.InstallDesktop => MudBlazor.Icons.Material.Filled.Download,
            OverlayIcons.System.Notifications => MudBlazor.Icons.Material.Filled.Notifications,
            OverlayIcons.System.Deblur => MudBlazor.Icons.Material.Filled.FilterCenterFocus,
            ...
            OverlayIcons.GameEntity.GarageDoor => MudBlazor.Icons.Material.Filled.Garage,
    ...
    private static string GetMaterialSymbolString(string iconName)
        => iconName switch
        {
            ...
            OverlayIcons.Navigation.Web => Outlined.Web,

            // Action icons
            OverlayIcons.Actions.FrameReload => Outlined.Refresh,
            OverlayIcons.Actions.Add => Outlined.Add,
            OverlayIcons.Actions.Remove => Outlined.Remove,
            OverlayIcons.Actions.Calculate => Outlined.Calculate,
            OverlayIcons.Actions.ContentCopy => Outlined.ContentCopy,
            ...
            OverlayIcons.System.ScreenshotMonitor => Outlined.Monitor,
            OverlayIcons.System.InstallDesktop => Outlined.Download,

            // Game entity icons (matching existing IconPicker.cs for visual consistency)
            OverlayIcons.GameEntity.Store => Outlined.Store,
            OverlayIcons.GameEntity.GarageDoor => Outlined.Garage,
            OverlayIcons.GameEntity.Commodity => Outlined.Diamond,
            OverlayIcons.GameEntity.SpaceShip => Outlined.Rocket,
            OverlayIcons.GameEntity.GroundVehicle => Outlined.LocalShipping,
            OverlayIcons.GameEntity.Item => Outlined.Category,
            OverlayIcons.GameEntity.ProductCategory => Outlined.Topic,
            OverlayIcons.GameEntity.Company => Outlined.Domain,
            OverlayIcons.GameEntity.Location => Outlined.Public,
            OverlayIcons.GameEntity.Flight => Outlined.Flight,

            // Trade icons
            OverlayIcons.Trade.AddShoppingCart => Outlined.AddShoppingCart,
            OverlayIcons.Trade.RemoveShoppingCart => Outlined.RemoveShoppingCart,
            OverlayIcons.Trade.CarRental => Outlined.CarRental,
            OverlayIcons.Trade.Storefront => Outlined.Storefront,
            OverlayIcons.Trade.Warehouse => Outlined.Warehouse,

            // Location icons
            OverlayIcons.Location.LocationOn => Outlined.LocationOn,
            OverlayIcons.Location.LocationOff => Outlined.LocationOff,

            // Status icons
            OverlayIcons.Status.Info => Outlined.Info,
            OverlayIcons.Status.Square => Outlined.Square,

            // Social icons
            OverlayIcons.Social.Groups => Outlined.Groups,
