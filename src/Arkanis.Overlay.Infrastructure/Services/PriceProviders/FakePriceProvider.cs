...
public class FakePriceProvider : IPriceProvider
{
    ...
    public ValueTask<List<PriceTag>> GetPriceTagsWithinAsync(IGamePurchasable gameEntity, IGameLocation? gameLocation)
        => ValueTask.FromResult<List<PriceTag>>([PriceTag.Unknown]);
    ...
    public ValueTask<List<PriceTag>> GetPriceTagsWithinAsync(IGameSellable gameEntity, IGameLocation? gameLocation)
        => ValueTask.FromResult<List<PriceTag>>([PriceTag.Unknown]);
    ...
    public ValueTask<List<PriceTag>> GetPriceTagsWithinAsync(IGameRentable gameEntity, IGameLocation? gameLocation)
        => ValueTask.FromResult<List<PriceTag>>([PriceTag.Unknown]);
